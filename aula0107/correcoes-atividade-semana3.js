...
// Outra forma: Desestruturação do array
// o valor do índice 0 é armazenado na variável 'usuário'
// o valor do índice 1 é armazenado na variável 'domínio'
const ofuscarEmail2 = (email) => {
    const [ usuario, dominio ] = email.split("@");
    return usuario [0] + "******" + "@" + dominio;
}

console.log(ofuscarEmail2("maria@hotmail.com"));
